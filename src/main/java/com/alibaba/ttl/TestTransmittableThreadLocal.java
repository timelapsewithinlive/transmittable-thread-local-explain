...
public class TestTransmittableThreadLocal {
    ...
    private static ExecutorService businessExecutors = TtlExecutors.getTtlExecutorService(Executors.newFixedThreadPool(4)); // 使用ttl线程池，该框架的使用，请查阅官方文档。
      ...
      */
      private static TransmittableThreadLocal<Integer> requestIdThreadLocal = new TransmittableThreadLocal<Integer>();
    ...
    //private static InheritableThreadLocal<Integer> requestIdThreadLocal = new InheritableThreadLocal<>();
      ...
      public static void main(String[] args) {
          ...
          ControlThread controlThread = new ControlThread(1);
          controlThread.run();
          //简单粗暴的关闭线程池
                try {
                        Thread.sleep(1000);
